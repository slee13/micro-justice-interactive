...
allQuestions = ["I say something at a meeting and nobody responds. A colleague says the same thing I did and everyone reacts positively.", "I’m told to be more assertive if I want to succeed.  But I’m also told that I should be likeable.", "When a colleague tells me to smile more.", "Have you ever?"]
