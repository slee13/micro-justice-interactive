...
# 					catch
					...
					firebaseRef.put("/MA",{questionId: "MA" + clickedLayer.questionId, optionId: clickedLayer.name})
					firebaseRef.database().push({questionId: "MA" + clickedLayer.questionId, optionId: clickedLayer.name})
					clickedLayer.animate
						scale: 1.42
						options:
							time: 0.22
