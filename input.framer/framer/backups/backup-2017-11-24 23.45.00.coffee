...
# 					catch
# 						count = 0
# 					firebaseRef.put("/answers/MA"+ clickedLayer.questionId + "/" + clickedLayer.name, 
# 						{counter:count+1,
...
# 					catch
					...
					firebaseRef.post("/MA",{questionId: "MA" + clickedLayer.questionId, optionId: clickedLayer.name})
					clickedLayer.animate
						scale: 1.42
						options:
							time: 0.22
